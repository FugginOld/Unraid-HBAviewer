...
| 030 | Gradient temperature bands, instrument tile, Health gauge | P1 | L | **021** | NOT STARTED — written 2026-08-01 against `0cbf845`. Design approved by the maintainer over five rounds of visual review. Carries an open decision at the top of the plan: the Health gauge has no numeric score in the codebase and the plan defaults to counting passing indicators rather than inventing one |
