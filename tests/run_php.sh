...
if command -v php >/dev/null 2>&1; then
    php tests/config_test.php && php tests/view_test.php && php tests/event_archive_test.php && php tests/cached_read_test.php && php tests/flash_php_test.php && php tests/ajax_render_test.php && php tests/health_test.php && php tests/notify_test.php && php tests/bundle_php_test.php && php tests/bay_map_test.php && php tests/locate_test.php && php tests/phy_baseline_test.php && php tests/export_test.php && php tests/plg_test.php && php tests/firmware_index_test.php && php tests/card_group_test.php && php tests/controller_schema_test.php
else
